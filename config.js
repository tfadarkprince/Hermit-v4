...
module.exports = {
  VERSION: 'v4.4.5',
  SESSION_ID: process.env.SESSION_ID || 'HP_2025_MAR_8_5M5ERZ',
  ...
  BOT_NAME: process.env.BOT_NAME || '𝐇𝐞𝐫𝐦𝐢𝐭-𝐕𝟒',
  ...
  BOT_INFO: process.env.BOT_INFO || 'tfadarkprince;ᴀᴅɪᴛʜyᴀɴ;918136880986;https://i.imgur.com/6oRG106.jpeg',
  AUDIO_DATA: process.env.AUDIO_DATA || 'tfadarkprince;ᴀᴅɪᴛʜyᴀɴ;https://i.imgur.com/fj2WE83.jpeg',
  STICKER_DATA: process.env.STICKER_DATA || 'tfadarkprince;ᴀᴅɪᴛʜyᴀɴ',
